...
(function ThisAssembly$Members () {
  ...
  JSIL.MakeStaticClass("ThisAssembly", false, [], function ($ib) {
    ...
    $.Constant({Static:true , Public:false}, "InformationalVersion", $.String, "4.8.9037.0");
...
(function $lSystem$daCollections$daIEnumerable$daGetEnumerator$gd__2$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:false}, "$lindex$g5__2", $.Int32);
...
(function RsaProtectedConfigurationProvider$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:false}, "GetSymEncryptionMethod", 
      JSIL.MethodSignature.Return($asm10.TypeRef("System.Security.Cryptography.Xml.EncryptionMethod"))
    );
...
(function FipsAwareEncryptedXml$Members () {
  ...
  JSIL.MakeType({
      BaseType: $asm10.TypeRef("System.Security.Cryptography.Xml.EncryptedXml"), 
    ...
    $.ExternalMethod({Static:false, Public:true , Virtual:true }, "GetDecryptionKey", 
      new JSIL.MethodSignature($asm06.TypeRef("System.Security.Cryptography.SymmetricAlgorithm"), [$asm10.TypeRef("System.Security.Cryptography.Xml.EncryptedData"), $.String])
    );

    $.ExternalMethod({Static:true , Public:false}, "IsAesDetected", 
      new JSIL.MethodSignature($.Boolean, [$asm10.TypeRef("System.Security.Cryptography.Xml.EncryptedData"), $.String])
    );
