  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true }, ".ctor", 
      new JSIL.MethodSignature(null, [
          $asm04.TypeRef("Microsoft.Xna.Framework.Input.Touch.GestureType"), $asm06.TypeRef("System.TimeSpan"), 
...
(function TouchCollection$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.IEnumerable$lMicrosoft.Xna.Framework.Input.Touch.TouchLocation$g.GetEnumerator", 
      JSIL.MethodSignature.Return($asm06.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm04.TypeRef("Microsoft.Xna.Framework.Input.Touch.TouchLocation")]))
    )
      .Overrides($asm06.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm04.TypeRef("Microsoft.Xna.Framework.Input.Touch.TouchLocation")]), "GetEnumerator");
    ...
    $.ImplementInterfaces(
      /* 0 */ $asm06.TypeRef("System.Collections.Generic.IList`1", [$asm04.TypeRef("Microsoft.Xna.Framework.Input.Touch.TouchLocation")]), 
      /* 1 */ $asm06.TypeRef("System.Collections.Generic.ICollection`1", [$asm04.TypeRef("Microsoft.Xna.Framework.Input.Touch.TouchLocation")]), 
      /* 2 */ $asm06.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm04.TypeRef("Microsoft.Xna.Framework.Input.Touch.TouchLocation")]), 
...
(function Enumerator$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ImplementInterfaces(
      /* 0 */ $asm06.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm04.TypeRef("Microsoft.Xna.Framework.Input.Touch.TouchLocation")]), 
...
(function TouchPanel$Members () {
  ...
  JSIL.MakeStaticClass("Microsoft.Xna.Framework.Input.Touch.TouchPanel", true, [], function ($ib) {
    ...
    $.Constant({Static:true , Public:false}, "AllGestureTypes", $asm04.TypeRef("Microsoft.Xna.Framework.Input.Touch.GestureType"), 1023);
